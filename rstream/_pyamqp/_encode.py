...
def encode_uint(
    output: bytearray, value: int, with_constructor: bool = True, use_smallest: bool = True
) -> None:
    """
        ...
        encode_value(
            output,
            {
                ...
                VALUE: (
                    ...
                    {TYPE: AMQPTypes.binary, VALUE: payload[5]},
                ),
            },
        )
...
def encode_frame(
    frame: Optional[NamedTuple], frame_type: bytes = _FRAME_TYPE
