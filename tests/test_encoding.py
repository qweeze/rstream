...
from rstream.encoding import decode_frame, encode_frame

frames = [
    schema.PeerProperties(
        correlation_id=1,
        properties=[schema.Property(key="product", value="rmq-streams-client")],
    ),
    ...
    schema.Deliver(
        ...
        num_entries=1,
        num_records=1,
        timestamp=1628717042903,
        epoch=1,
        chunk_first_offset=239,
        chunk_crc=3486439553,
        data_length=10,
        trailer_length=30,
        _reserved=0,
        data=b"\x00\x00\x00\x06msg: 9",
    ),
